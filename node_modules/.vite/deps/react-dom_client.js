import {
  require_react_dom
} from "./chunk-6CPJQYFI.js";
import {
  require_react
} from "./chunk-HNKBQCBG.js";
import {
  __commonJS
  ...
  "node_modules/react-dom/cjs/react-dom-client.development.js"(exports) {
    ...
    (function() {
      ...
      function getLanesToRetrySynchronouslyOnError(root2, originallyAttemptedLanes) {
        if (root2.errorRecoveryDisabledLanes & originallyAttemptedLanes) return 0;
      ...
      function findHostInstancesForMatchingFibersRecursively(fiber, types, hostInstances) {
        ...
        if (type)
          a: {
            b: for (child = fiber, candidateType = false; ; ) {
        ...
        function reconcileChildFibersImpl(returnFiber, currentFirstChild, newChild, lanes) {
          ...
          if ("object" === typeof newChild && null !== newChild) {
              ...
              case REACT_ELEMENT_TYPE:
                ...
                a: {
                  ...
                  newChild.type === REACT_FRAGMENT_TYPE ? (currentFirstChild = createFiberFromFragment(
                    ...
                    lanes,
                    newChild.key
                  ), currentFirstChild.return = returnFiber, currentFirstChild._debugOwner = returnFiber, currentFirstChild._debugInfo = currentDebugInfo, validateFragmentProps(
                    newChild,
                    currentFirstChild,
                    returnFiber
            ...
            if (getIteratorFn(newChild)) {
              ...
              if (key === newChild) {
                ...
                newChild.entries !== child || didWarnAboutMaps || (console.error(
          ...
          if ("string" === typeof newChild && "" !== newChild || "number" === typeof newChild || "bigint" === typeof newChild)
            return prevDebugInfo = "" + newChild, null !== currentFirstChild && 6 === currentFirstChild.tag ? (deleteRemainingChildren(
              ...
              returnFiber.mode,
              lanes
            ), currentFirstChild.return = returnFiber, currentFirstChild._debugOwner = returnFiber, currentFirstChild._debugInfo = currentDebugInfo, returnFiber = currentFirstChild), placeSingleChild(returnFiber);
          "function" === typeof newChild && warnOnFunctionType(returnFiber, newChild);
          "symbol" === typeof newChild && warnOnSymbolType(returnFiber, newChild);
      ...
      function defaultOnCaughtError(error, errorInfo) {
        ...
        try {
          "object" === typeof error && null !== error && "string" === typeof error.environmentName ? printToConsole(
            "error",
            [
              "%o\n\n%s\n\n%s\n",
              error,
      ...
      function initializeClassErrorUpdate(update, root2, fiber, errorInfo) {
        ...
        null !== inst && "function" === typeof inst.componentDidCatch && (update.callback = function() {
          ...
          "function" === typeof getDerivedStateFromError || 0 === (fiber.lanes & SyncLane) && console.error(
      ...
      function updateFunctionComponent(current2, workInProgress2, Component, nextProps, renderLanes2) {
        ...
        null === current2 && (validateFunctionComponentInDev(workInProgress2, workInProgress2.type), Component.contextTypes && (componentName2 = getComponentNameFromType(Component) || "Unknown", didWarnAboutContextTypes$1[componentName2] || (didWarnAboutContextTypes$1[componentName2] = true, console.error(
      ...
      function updateClassComponent(current$jscomp$0, workInProgress2, Component, nextProps, renderLanes2) {
        ...
        if (null === workInProgress2.stateNode) {
          ...
          Component.contextTypes && !didWarnAboutContextTypes.has(Component) && (didWarnAboutContextTypes.add(Component), console.error(
      ...
      function updateSuspenseComponent(current2, workInProgress2, renderLanes2) {
        var JSCompiler_object_inline_digest_2305;
        var JSCompiler_object_inline_stack_2306 = workInProgress2.pendingProps;
        shouldSuspendImpl(workInProgress2) && (workInProgress2.flags |= 128);
        var JSCompiler_object_inline_componentStack_2307 = false;
        var didSuspend = 0 !== (workInProgress2.flags & 128);
        (JSCompiler_object_inline_digest_2305 = didSuspend) || (JSCompiler_object_inline_digest_2305 = null !== current2 && null === current2.memoizedState ? false : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_digest_2305 && (JSCompiler_object_inline_componentStack_2307 = true, workInProgress2.flags &= -129);
        JSCompiler_object_inline_digest_2305 = 0 !== (workInProgress2.flags & 32);
        workInProgress2.flags &= -33;
        if (null === current2) {
          if (isHydrating) {
            JSCompiler_object_inline_componentStack_2307 ? pushPrimaryTreeSuspenseHandler(workInProgress2) : reuseSuspenseHandlerOnStack(workInProgress2);
            if (isHydrating) {
              var JSCompiler_object_inline_message_2304 = nextHydratableInstance;
              var JSCompiler_temp;
              if (!(JSCompiler_temp = !JSCompiler_object_inline_message_2304)) {
                c: {
                  var instance = JSCompiler_object_inline_message_2304;
              ...
              JSCompiler_temp && (warnNonHydratedInstance(
                workInProgress2,
                JSCompiler_object_inline_message_2304
              ), throwOnHydrationMismatch(workInProgress2));
            }
            JSCompiler_object_inline_message_2304 = workInProgress2.memoizedState;
            if (null !== JSCompiler_object_inline_message_2304 && (JSCompiler_object_inline_message_2304 = JSCompiler_object_inline_message_2304.dehydrated, null !== JSCompiler_object_inline_message_2304))
              return JSCompiler_object_inline_message_2304.data === SUSPENSE_FALLBACK_START_DATA ? workInProgress2.lanes = DefaultHydrationLane : workInProgress2.lanes = OffscreenLane, null;
            popSuspenseHandler(workInProgress2);
          }
          JSCompiler_object_inline_message_2304 = JSCompiler_object_inline_stack_2306.children;
          JSCompiler_object_inline_stack_2306 = JSCompiler_object_inline_stack_2306.fallback;
          if (JSCompiler_object_inline_componentStack_2307)
            return reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2307 = workInProgress2.mode, JSCompiler_object_inline_message_2304 = mountWorkInProgressOffscreenFiber(
              {
                mode: "hidden",
                children: JSCompiler_object_inline_message_2304
              },
              JSCompiler_object_inline_componentStack_2307
            ), JSCompiler_object_inline_stack_2306 = createFiberFromFragment(
              JSCompiler_object_inline_stack_2306,
              JSCompiler_object_inline_componentStack_2307,
              renderLanes2,
              null
            ), JSCompiler_object_inline_message_2304.return = workInProgress2, JSCompiler_object_inline_stack_2306.return = workInProgress2, JSCompiler_object_inline_message_2304.sibling = JSCompiler_object_inline_stack_2306, workInProgress2.child = JSCompiler_object_inline_message_2304, JSCompiler_object_inline_componentStack_2307 = workInProgress2.child, JSCompiler_object_inline_componentStack_2307.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_componentStack_2307.childLanes = getRemainingWorkInPrimaryTree(
              current2,
              JSCompiler_object_inline_digest_2305,
              renderLanes2
            ), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2306;
        ...
        if (null !== prevState && (JSCompiler_object_inline_message_2304 = prevState.dehydrated, null !== JSCompiler_object_inline_message_2304)) {
          if (didSuspend)
            workInProgress2.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress2), workInProgress2.flags &= -257, workInProgress2 = retrySuspenseComponentWithoutHydrating(
              current2,
              workInProgress2,
              renderLanes2
            )) : null !== workInProgress2.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress2), workInProgress2.child = current2.child, workInProgress2.flags |= 128, workInProgress2 = null) : (reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2307 = JSCompiler_object_inline_stack_2306.fallback, JSCompiler_object_inline_message_2304 = workInProgress2.mode, JSCompiler_object_inline_stack_2306 = mountWorkInProgressOffscreenFiber(
              {
                mode: "visible",
                children: JSCompiler_object_inline_stack_2306.children
              },
              JSCompiler_object_inline_message_2304
            ), JSCompiler_object_inline_componentStack_2307 = createFiberFromFragment(
              JSCompiler_object_inline_componentStack_2307,
              JSCompiler_object_inline_message_2304,
              renderLanes2,
              null
            ), JSCompiler_object_inline_componentStack_2307.flags |= 2, JSCompiler_object_inline_stack_2306.return = workInProgress2, JSCompiler_object_inline_componentStack_2307.return = workInProgress2, JSCompiler_object_inline_stack_2306.sibling = JSCompiler_object_inline_componentStack_2307, workInProgress2.child = JSCompiler_object_inline_stack_2306, reconcileChildFibers(
              workInProgress2,
              current2.child,
              null,
              renderLanes2
            ), JSCompiler_object_inline_stack_2306 = workInProgress2.child, JSCompiler_object_inline_stack_2306.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_stack_2306.childLanes = getRemainingWorkInPrimaryTree(
              current2,
              JSCompiler_object_inline_digest_2305,
              renderLanes2
            ), workInProgress2.memoizedState = SUSPENDED_MARKER, workInProgress2 = JSCompiler_object_inline_componentStack_2307);
          else if (pushPrimaryTreeSuspenseHandler(workInProgress2), isHydrating && console.error(
            "We should not be hydrating here. This is a bug in React. Please file a bug."
          ), JSCompiler_object_inline_message_2304.data === SUSPENSE_FALLBACK_START_DATA) {
            JSCompiler_object_inline_digest_2305 = JSCompiler_object_inline_message_2304.nextSibling && JSCompiler_object_inline_message_2304.nextSibling.dataset;
            if (JSCompiler_object_inline_digest_2305) {
              JSCompiler_temp = JSCompiler_object_inline_digest_2305.dgst;
              var message = JSCompiler_object_inline_digest_2305.msg;
              instance = JSCompiler_object_inline_digest_2305.stck;
              var componentStack = JSCompiler_object_inline_digest_2305.cstck;
            }
            JSCompiler_object_inline_message_2304 = message;
            JSCompiler_object_inline_digest_2305 = JSCompiler_temp;
            JSCompiler_object_inline_stack_2306 = instance;
            JSCompiler_object_inline_componentStack_2307 = componentStack;
            JSCompiler_object_inline_message_2304 = JSCompiler_object_inline_message_2304 ? Error(JSCompiler_object_inline_message_2304) : Error(
              "The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering."
            );
            JSCompiler_object_inline_message_2304.stack = JSCompiler_object_inline_stack_2306 || "";
            JSCompiler_object_inline_message_2304.digest = JSCompiler_object_inline_digest_2305;
            JSCompiler_object_inline_digest_2305 = void 0 === JSCompiler_object_inline_componentStack_2307 ? null : JSCompiler_object_inline_componentStack_2307;
            "string" === typeof JSCompiler_object_inline_digest_2305 && CapturedStacks.set(
              JSCompiler_object_inline_message_2304,
              JSCompiler_object_inline_digest_2305
            );
            queueHydrationError({
              value: JSCompiler_object_inline_message_2304,
              source: null,
              stack: JSCompiler_object_inline_digest_2305
            });
          ...
          } else if (JSCompiler_object_inline_digest_2305 = 0 !== (renderLanes2 & current2.childLanes), didReceiveUpdate || JSCompiler_object_inline_digest_2305) {
            JSCompiler_object_inline_digest_2305 = workInProgressRoot;
            if (null !== JSCompiler_object_inline_digest_2305) {
              JSCompiler_object_inline_stack_2306 = renderLanes2 & -renderLanes2;
              if (0 !== (JSCompiler_object_inline_stack_2306 & SyncUpdateLanes))
                JSCompiler_object_inline_stack_2306 = SyncHydrationLane;
              else
                switch (JSCompiler_object_inline_stack_2306) {
                  case SyncLane:
                    JSCompiler_object_inline_stack_2306 = SyncHydrationLane;
                    break;
                  case InputContinuousLane:
                    JSCompiler_object_inline_stack_2306 = InputContinuousHydrationLane;
                    break;
                  case DefaultLane:
                    JSCompiler_object_inline_stack_2306 = DefaultHydrationLane;
                    break;
                  case 128:
                  case 256:
                  case 512:
                  ...
                  case 16777216:
                  case 33554432:
                    JSCompiler_object_inline_stack_2306 = TransitionHydrationLane;
                    break;
                  case IdleLane:
                    JSCompiler_object_inline_stack_2306 = IdleHydrationLane;
                    break;
                  default:
                    JSCompiler_object_inline_stack_2306 = 0;
                }
              JSCompiler_object_inline_stack_2306 = 0 !== (JSCompiler_object_inline_stack_2306 & (JSCompiler_object_inline_digest_2305.suspendedLanes | renderLanes2)) ? 0 : JSCompiler_object_inline_stack_2306;
              if (0 !== JSCompiler_object_inline_stack_2306 && JSCompiler_object_inline_stack_2306 !== prevState.retryLane)
                throw prevState.retryLane = JSCompiler_object_inline_stack_2306, enqueueConcurrentRenderForLane(
                  current2,
                  JSCompiler_object_inline_stack_2306
            ...
            JSCompiler_object_inline_message_2304.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
            workInProgress2 = retrySuspenseComponentWithoutHydrating(
              current2,
              workInProgress2,
              renderLanes2
            ...
            JSCompiler_object_inline_message_2304.data === SUSPENSE_PENDING_START_DATA ? (workInProgress2.flags |= 128, workInProgress2.child = current2.child, workInProgress2 = retryDehydratedSuspenseBoundary.bind(
              null,
              current2
            ), JSCompiler_object_inline_message_2304._reactRetry = workInProgress2, workInProgress2 = null) : (current2 = prevState.treeContext, nextHydratableInstance = getNextHydratable(
              JSCompiler_object_inline_message_2304.nextSibling
            ), hydrationParentFiber = workInProgress2, isHydrating = true, hydrationErrors = null, didSuspendOrErrorDEV = false, hydrationDiffRootDEV = null, rootOrSingletonContext = false, null !== current2 && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current2.id, treeContextOverflow = current2.overflow, treeContextProvider = workInProgress2), workInProgress2 = mountSuspensePrimaryChildren(
              workInProgress2,
              JSCompiler_object_inline_stack_2306.children
            ), workInProgress2.flags |= 4096);
          return workInProgress2;
        }
        if (JSCompiler_object_inline_componentStack_2307)
          return reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2307 = JSCompiler_object_inline_stack_2306.fallback, JSCompiler_object_inline_message_2304 = workInProgress2.mode, JSCompiler_temp = current2.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2306 = createWorkInProgress(
            JSCompiler_temp,
            {
              mode: "hidden",
              children: JSCompiler_object_inline_stack_2306.children
            }
          ), JSCompiler_object_inline_stack_2306.subtreeFlags = JSCompiler_temp.subtreeFlags & 31457280, null !== instance ? JSCompiler_object_inline_componentStack_2307 = createWorkInProgress(
            instance,
            JSCompiler_object_inline_componentStack_2307
          ) : (JSCompiler_object_inline_componentStack_2307 = createFiberFromFragment(
            JSCompiler_object_inline_componentStack_2307,
            ...
            renderLanes2,
            null
          ), JSCompiler_object_inline_componentStack_2307.flags |= 2), JSCompiler_object_inline_componentStack_2307.return = workInProgress2, JSCompiler_object_inline_stack_2306.return = workInProgress2, JSCompiler_object_inline_stack_2306.sibling = JSCompiler_object_inline_componentStack_2307, workInProgress2.child = JSCompiler_object_inline_stack_2306, JSCompiler_object_inline_stack_2306 = JSCompiler_object_inline_componentStack_2307, JSCompiler_object_inline_componentStack_2307 = workInProgress2.child, JSCompiler_object_inline_message_2304 = current2.child.memoizedState, null === JSCompiler_object_inline_message_2304 ? JSCompiler_object_inline_message_2304 = mountSuspenseOffscreenState(renderLanes2) : (JSCompiler_temp = JSCompiler_object_inline_message_2304.cachePool, null !== JSCompiler_temp ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? { parent: instance, pool: instance } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_message_2304 = {
            baseLanes: JSCompiler_object_inline_message_2304.baseLanes | renderLanes2,
            cachePool: JSCompiler_temp
          }), JSCompiler_object_inline_componentStack_2307.memoizedState = JSCompiler_object_inline_message_2304, JSCompiler_object_inline_componentStack_2307.childLanes = getRemainingWorkInPrimaryTree(
            current2,
            JSCompiler_object_inline_digest_2305,
            renderLanes2
          ), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2306;
        ...
        null !== current2 && (JSCompiler_object_inline_digest_2305 = workInProgress2.deletions, null === JSCompiler_object_inline_digest_2305 ? (workInProgress2.deletions = [current2], workInProgress2.flags |= 16) : JSCompiler_object_inline_digest_2305.push(current2));
      ...
      function bailoutOnAlreadyFinishedWork(current2, workInProgress2, renderLanes2) {
        ...
        if (0 === (renderLanes2 & workInProgress2.childLanes)) return null;
        ...
        switch (workInProgress2.tag) {
          ...
          case 10:
            a: {
              ...
              "value" in prevSibling || hasWarnedAboutUsingNoValuePropOnContextProvider || (hasWarnedAboutUsingNoValuePropOnContextProvider = true, console.error(
        ...
        try {
          ...
          if (null !== ref) {
            ...
            if ("function" === typeof ref)
              ...
              else current2.refCleanup = ref(instanceToUse);
            else
        ...
        switch (finishedWork.tag) {
          ...
          case 1:
            if (0 !== (flags & 1024) && null !== current2) {
              ...
              void 0 !== flags || prevState.has(finishedWork.type) || (prevState.add(finishedWork.type), console.error(
          ...
          case 3:
            if (0 !== (flags & 1024)) {
              a: if (finishedWork = finishedWork.stateNode.containerInfo, current2 = finishedWork.nodeType, 9 === current2)
        ...
        if (null !== updateQueue) {
          ...
          do {
            if ((effect.tag & flags) === flags) {
              ...
              void 0 !== create && "function" !== typeof create && (inst = 0 !== (effect.tag & Layout) ? "useLayoutEffect" : 0 !== (effect.tag & Insertion) ? "useInsertionEffect" : "useEffect", console.error(
          ...
          case 1:
            ...
            if (flags & 4)
              if (finishedRoot = finishedWork.stateNode, null === current2)
                if (finishedWork.type.defaultProps || "ref" in finishedWork.memoizedProps || didWarnAboutReassigningProps || (finishedRoot.props !== finishedWork.memoizedProps && console.error(
        ...
        switch (finishedWork.tag) {
          ...
          case 27:
            if (flags & 4 && null === finishedWork.alternate) {
              ...
              getInstanceFromNode(hoistableRoot) && (nextNode = hoistableRoot.tagName.toLowerCase(), console.error(
      ...
      function performSyncWorkOnRoot(root2, lanes) {
        if ((executionContext & (RenderContext | CommitContext)) !== NoContext)
          throw Error("Should not already be working.");
        if (flushPassiveEffects()) return ensureRootIsScheduled(root2), null;
      ...
      function renderRootSync(root2, lanes) {
        ...
        a: do
          try {
            ...
            workLoopSync();
            break;
          } catch (thrownValue$22) {
            handleThrow(root2, thrownValue$22);
          }
        while (1);
      ...
      function renderRootConcurrent(root2, lanes) {
        ...
        a: do
          try {
            ...
            break;
          } catch (thrownValue$23) {
            handleThrow(root2, thrownValue$23);
          }
        while (1);
        resetContextDependencies();
        ReactSharedInternals.H = prevDispatcher;
      ...
      function completeUnitOfWork(unitOfWork) {
        ...
        do {
          0 !== (completedWork.flags & 32768) && console.error(
      ...
      function commitRootImpl(root2, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, renderPriorityLevel, spawnedLane) {
        ...
        } else root2.current = finishedWork, commitTime = now();
          ...
          for (; null !== nearestMountedAncestor; ) {
            ...
            if (1 === nearestMountedAncestor.tag) {
              ...
              if ("function" === typeof nearestMountedAncestor.type.getDerivedStateFromError || "function" === typeof instance.componentDidCatch && (null === legacyErrorBoundariesThatAlreadyFailed || !legacyErrorBoundariesThatAlreadyFailed.has(instance))) {
                sourceFiber = createCapturedValueAtFiber(error, sourceFiber);
                error = createClassErrorUpdate(SyncLane);
                instance = enqueueUpdate(nearestMountedAncestor, error, SyncLane);
      ...
      function setProp(domElement, tag, key, value, props, prevValue) {
        switch (key) {
          ...
          case "formAction":
            ...
            )) : "action" === key ? console.error("You can only pass the action prop to <form>.") : console.error(
      ...
      function FiberRootNode(containerInfo, tag, hydrate, identifierPrefix, onUncaughtError, onCaughtError, onRecoverableError, formState) {
        ...
        for (tag = 0; tag < TotalLanes; tag++) containerInfo.push(/* @__PURE__ */ new Set());
      ...
      var didWarnAboutContextTypes$1 = {};
      ...
      var didWarnAboutContextTypes = /* @__PURE__ */ new Set();
      ...
      (function() {
        ...
        if ("19.0.0-rc-8b08e99e-20240713" !== isomorphicReactPackageVersion)
          throw Error(
      ...
      if (!function(devToolsConfig) {
        return injectInternals({
          ...
          reconcilerVersion: "19.0.0-rc-8b08e99e-20240713"
        });
      }({
